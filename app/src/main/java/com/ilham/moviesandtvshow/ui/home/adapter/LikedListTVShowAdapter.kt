...
class LikedListTVShowAdapter :
    PagedListAdapter<TVShowModel, LikedListTVShowAdapter.ViewHolder>(DIFF_CALLBACK) {
        ...
        fun bind(tvShowModel: TVShowModel) {
            with(itemView) {
                ...
                for (genres in 0 until tvShowModel.genre!!.size) {
                    val genreItem =
                        genreTextView(" ${Constants.getGenres(tvShowModel.genre!![genres])} ")
