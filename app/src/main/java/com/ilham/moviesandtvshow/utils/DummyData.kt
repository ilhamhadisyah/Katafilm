    ...
    fun generateDataMovieDummy(): List<MovieModel> {
        ...
        listMovie.add(
            MovieModel(
                ...
                backdropPath = "https://image.tmdb.org/t/p/original/xcaSYLBhmDzJ6P14bcKe0KTh3QV.jpg",
                isFavorite = false
            )
        )
    ...
    fun generateDataTvShowDummy(): List<TVShowModel> {
        ...
        listTvShow.add(
            TVShowModel(
                id = 13,
                name = "Dragon Ball",
                overview = "Long ago in the mountains, a fighting master known as Gohan discovered a strange boy whom hetitle d Goku. Gohan raised him and trained Goku in martial arts until he died. The young and very strong boy was on his own, but easily managed. Then one day, Goku met a teenage girltitle d Bulma, whose search for the mystical Dragon Balls brought her to Goku\\'s home. Together, they set off to find all seven and to grant her wish.",
